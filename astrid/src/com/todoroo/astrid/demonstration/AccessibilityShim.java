...
public class AccessibilityShim {
    ...
    //// XXX acvogel
    ///** Returns the root element in the decorView hierarchy. */
    //public static AccessibleFrameLayout getFrameLayout(View decorView) {
    ...
    private static boolean isAccessibilityEnabled(Context context) {
        ...
        // XXX turn it on for testing purposes
        return true;
        //return (enabled == 1);
    }
