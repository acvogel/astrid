...
public class GreenActionBar extends LinearLayout {

    private static final String LOG_TAG = GreenActionBar.class.getSimpleName();
    ...
    private GreenActionBar.Type mType;
    ...
    public GreenActionBar(Context context) {
        this(context, null);
    }

    public GreenActionBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.gdActionBarStyle);
    }

    public GreenActionBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
