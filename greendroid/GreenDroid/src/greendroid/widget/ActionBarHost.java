...
public class ActionBarHost extends LinearLayout {
    ...
    private GreenActionBar mActionBar;
    ...
    protected void onFinishInflate() {
        ...
        mActionBar = (GreenActionBar) findViewById(R.id.gd_action_bar);
        if (mActionBar == null || !(mActionBar instanceof GreenActionBar)) {
    ...
    public GreenActionBar getActionBar() {
        return mActionBar;
    }
